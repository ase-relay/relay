...
export function LocationInput({ id, kind, value, placeholder, isActive, suggestions, isLoading, isLocating = false, onChange, onFocus, onBlur, onSelect, onUseCurrentLocation }: LocationInputProps) {
