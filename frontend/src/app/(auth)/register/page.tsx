...
export default function RegisterPage() {
    ...
    function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        setSubmitted(true);
        if (!formValid) return;
        // TODO: sambungkan registrasi ke API autentikasi.
    }
            ...
            <section className="flex items-center justify-center px-6 py-10 sm:px-12 lg:px-16 xl:px-18">
                <div className="w-full max-w-lg">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="mt-7 space-y-4">
                        ...
                        <button type="submit" disabled={!formValid} className="w-full cursor-pointer rounded-xl bg-primary-600 py-3 text-sm font-semibold text-white transition hover:bg-primary-700 disabled:cursor-not-allowed disabled:bg-neutral-400 disabled:hover:bg-neutral-400">Daftar</button>
                    </form>
